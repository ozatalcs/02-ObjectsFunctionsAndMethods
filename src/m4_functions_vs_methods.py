...
def try_methods_and_functions():
    bobisthebest = rg.SimpleTurtle()
    bobisthebest.pen = rg.Pen('blue', 5)
    bobisthebest.backward(150)
    bobisthebest.speed = 1
    draw_many_squares(bobisthebest,2,100,30)
    bobisthebest.speed = 5
    bobisthebest.pen = rg.Pen('red', 5)
    draw_many_squares(bobisthebest,10,50,15)
    bobisthebest.speed = 100
    bobisthebest.pen = rg.Pen('red', 35)
    draw_many_squares(bobisthebest,8,300,60)
    bobisthebest.pen = rg.Pen('black', 3)
    bobisthebest.backward(200)
    bobisthebest.draw_circle(30)
    draw_many_squares(bobisthebest,1,50,90)
    """
    Constructs a SimpleTurtle and sets its   pen  to a new rg.Pen
