...
def main():
    ...
    #even_better_draw_circles(rg.Point(100, 50),5,8,'red',1)
    #even_better_draw_circles(rg.Point(-200, 0),20,12,'blue',4)
    even_better_draw_circles(rg.Point(0, 0),15,50,'green',3,0)
    even_better_draw_circles(rg.Point(0, 0),15,50,'red',3,7.5)
    even_better_draw_circles(rg.Point(0, 0), 15, 50, 'red', 3, -7.5)
...
def better_draw_circles(point,radius_increase):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radius_increase)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radius_increase * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point,radius_increase,number,color,thickness,initial):
    turtle = rg.SimpleTurtle()
    ...
    for k in range(1, number):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radius_increase + initial)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radius_increase * k + initial)
